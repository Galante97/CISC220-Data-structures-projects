...
void setup::intializeMenu() {
	...
	cout << endl << "Welcome to the you library!" << endl;
	cout << "There are already " << bookDirectory->size
			<< " books in your library, search through it,"
					"or add your own!" << endl << endl;
	cout << "Type a letter to perform an action:" << endl;
	cout << "A - To view all the books in this library in alphabetical order."
			<< endl;
	cout
			<< "B - To view all the categories of books in this library, plus how many."
			<< endl;
	cout << "C - View all the book from a range of years" << endl;
	cout << "D - View all the books of a certain range of pages" << endl;
	cout << "E - Add your own book!" << endl;
	cout << "F - General Search" << endl;
	getline(std::cin, uChar);
	...
	if (uChar == "A") {
		...
		cout << "F" << endl;
		bookDirectory->generalSearch();

		cout << "-----------------------------" << endl;
		intializeMenu();

	} else if (uChar != "A" || uChar != "B" || uChar != "C" || uChar != "D"
			|| uChar != "E" || uChar != "F") {
